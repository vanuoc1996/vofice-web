...
import {CountryTableLOVBaseComponent} from './base/country-table-lov.component.base';
import {TABLE_LOV_CONFIG} from './config/table-lov-config.js';

@Component({
	selector: 'app-country-table-lov',
	templateUrl: './html/country-table-lov.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: CountryTableLOVComponent,
			multi: true
		}
	]
})
export class CountryTableLOVComponent extends CountryTableLOVBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
