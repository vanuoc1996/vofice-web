...
import {CountryEditBaseComponent} from './base/country-edit.component.base';
import {EDIT_CONFIG} from './config/edit-config.js';

@Component({
	selector: 'app-country-edit',
	templateUrl: './html/country-edit.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: CountryEditComponent,
			multi: true
		}
	]
})
export class CountryEditComponent extends CountryEditBaseComponent implements OnInit {
	constructor(
		http: HttpClient,
		router: Router,
