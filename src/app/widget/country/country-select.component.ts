...
import {CountrySelectBaseComponent} from './base/country-select.component.base';
import {SELECT_CONFIG} from './config/select-config.js';

@Component({
	selector: 'app-country-select',
	templateUrl: './html/country-select.html',
	providers: [
		{
...
export class CountrySelectComponent extends CountrySelectBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
