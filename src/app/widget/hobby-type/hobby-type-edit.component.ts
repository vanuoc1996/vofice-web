...
import {HobbyTypeEditBaseComponent} from './base/hobby-type-edit.component.base';
import {EDIT_CONFIG} from './config/edit-config.js';

@Component({
	selector: 'app-hobby-type-edit',
	templateUrl: './html/hobby-type-edit.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: HobbyTypeEditComponent,
			multi: true
		}
	]
})
export class HobbyTypeEditComponent extends HobbyTypeEditBaseComponent implements OnInit {
	constructor(
		http: HttpClient,
		router: Router,
