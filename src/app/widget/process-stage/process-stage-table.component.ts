...
import {ProcessStageTableBaseComponent} from './base/process-stage-table.component.base';
import {TABLE_CONFIG} from './config/table-config.js';

@Component({
	selector: 'app-process-stage-table',
	templateUrl: './html/process-stage-table.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: ProcessStageTableComponent,
			multi: true
		}
	]
})
export class ProcessStageTableComponent extends ProcessStageTableBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
