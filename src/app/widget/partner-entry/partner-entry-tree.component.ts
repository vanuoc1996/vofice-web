...
import {PartnerTreeBaseComponent} from './base/partner-entry-tree.component.base';
import {TREE_CONFIG} from './config/tree-config.js';

@Component({
	selector: 'app-partner-tree',
	templateUrl: './html/partner-entry-tree.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: PartnerTreeComponent,
			multi: true
		}
	]
})
export class PartnerTreeComponent extends PartnerTreeBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
