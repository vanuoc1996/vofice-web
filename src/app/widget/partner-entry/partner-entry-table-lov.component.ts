...
import {PartnerTableLOVBaseComponent} from './base/partner-entry-table-lov.component.base';
import {TABLE_LOV_CONFIG} from './config/table-lov-config.js';

@Component({
	selector: 'app-partner-table-lov',
	templateUrl: './html/partner-entry-table-lov.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: PartnerTableLOVComponent,
			multi: true
		}
	]
})
export class PartnerTableLOVComponent extends PartnerTableLOVBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
