...
import {PartnerSelectBaseComponent} from './base/partner-entry-select.component.base';
import {SELECT_CONFIG} from './config/select-config.js';

@Component({
	selector: 'app-partner-select',
	templateUrl: './html/partner-entry-select.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: PartnerSelectComponent,
			multi: true
		}
	]
})
export class PartnerSelectComponent extends PartnerSelectBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
