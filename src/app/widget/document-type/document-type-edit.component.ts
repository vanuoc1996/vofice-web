...
import {DocumentTypeEditBaseComponent} from './base/document-type-edit.component.base';
import {EDIT_CONFIG} from './config/edit-config.js';

@Component({
	selector: 'app-document-type-edit',
	templateUrl: './html/document-type-edit.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: DocumentTypeEditComponent,
			multi: true
		}
	]
})
export class DocumentTypeEditComponent extends DocumentTypeEditBaseComponent implements OnInit {
	constructor(
		http: HttpClient,
		router: Router,
