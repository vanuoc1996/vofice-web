...
import {DocumentTypeTableLOVBaseComponent} from './base/document-type-table-lov.component.base';
import {TABLE_LOV_CONFIG} from './config/table-lov-config.js';

@Component({
	selector: 'app-document-type-table-lov',
	templateUrl: './html/document-type-table-lov.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: DocumentTypeTableLOVComponent,
			multi: true
		}
	]
})
export class DocumentTypeTableLOVComponent extends DocumentTypeTableLOVBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
