...
import {PartnerEducationTableLOVBaseComponent} from './base/partner-education-table-lov.component.base';
import {TABLE_LOV_CONFIG} from './config/table-lov-config.js';

@Component({
	selector: 'app-partner-education-table-lov',
	templateUrl: './html/partner-education-table-lov.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: PartnerEducationTableLOVComponent,
			multi: true
		}
	]
})
export class PartnerEducationTableLOVComponent extends PartnerEducationTableLOVBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
