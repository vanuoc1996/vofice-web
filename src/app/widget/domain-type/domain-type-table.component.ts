...
import {DomainTypeTableBaseComponent} from './base/domain-type-table.component.base';
import {TABLE_CONFIG} from './config/table-config.js';

@Component({
	selector: 'app-domain-type-table',
	templateUrl: './html/domain-type-table.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: DomainTypeTableComponent,
			multi: true
		}
	]
})
export class DomainTypeTableComponent extends DomainTypeTableBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
