...
import {DomainTypeEditBaseComponent} from './base/domain-type-edit.component.base';
import {EDIT_CONFIG} from './config/edit-config.js';

@Component({
	selector: 'app-domain-type-edit',
	templateUrl: './html/domain-type-edit.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: DomainTypeEditComponent,
			multi: true
		}
	]
})
export class DomainTypeEditComponent extends DomainTypeEditBaseComponent implements OnInit {
	constructor(
		http: HttpClient,
		router: Router,
