...
import {NationalTypeEditBaseComponent} from './base/national-type-edit.component.base';
import {EDIT_CONFIG} from './config/edit-config.js';

@Component({
	selector: 'app-national-type-edit',
	templateUrl: './html/national-type-edit.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: NationalTypeEditComponent,
			multi: true
		}
	]
})
export class NationalTypeEditComponent extends NationalTypeEditBaseComponent implements OnInit {
	constructor(
		http: HttpClient,
		router: Router,
