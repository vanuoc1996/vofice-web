...
import {NationalTypeTableBaseComponent} from './base/national-type-table.component.base';
import {TABLE_CONFIG} from './config/table-config.js';

@Component({
	selector: 'app-national-type-table',
	templateUrl: './html/national-type-table.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: NationalTypeTableComponent,
			multi: true
		}
	]
})
export class NationalTypeTableComponent extends NationalTypeTableBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
