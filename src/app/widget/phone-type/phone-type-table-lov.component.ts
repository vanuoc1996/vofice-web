...
import {PhoneTypeTableLOVBaseComponent} from './base/phone-type-table-lov.component.base';
import {TABLE_LOV_CONFIG} from './config/table-lov-config.js';

@Component({
	selector: 'app-phone-type-table-lov',
	templateUrl: './html/phone-type-table-lov.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: PhoneTypeTableLOVComponent,
			multi: true
		}
	]
})
export class PhoneTypeTableLOVComponent extends PhoneTypeTableLOVBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
