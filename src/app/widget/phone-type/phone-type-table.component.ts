...
import {PhoneTypeTableBaseComponent} from './base/phone-type-table.component.base';
import {TABLE_CONFIG} from './config/table-config.js';

@Component({
	selector: 'app-phone-type-table',
	templateUrl: './html/phone-type-table.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: PhoneTypeTableComponent,
			multi: true
		}
	]
})
export class PhoneTypeTableComponent extends PhoneTypeTableBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
