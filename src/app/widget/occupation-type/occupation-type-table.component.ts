...
import {OccupationTypeTableBaseComponent} from './base/occupation-type-table.component.base';
import {TABLE_CONFIG} from './config/table-config.js';

@Component({
	selector: 'app-occupation-type-table',
	templateUrl: './html/occupation-type-table.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: OccupationTypeTableComponent,
			multi: true
		}
	]
})
export class OccupationTypeTableComponent extends OccupationTypeTableBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
