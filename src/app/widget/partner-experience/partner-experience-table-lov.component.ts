...
import {PartnerExperienceTableLOVBaseComponent} from './base/partner-experience-table-lov.component.base';
import {TABLE_LOV_CONFIG} from './config/table-lov-config.js';

@Component({
	selector: 'app-partner-experience-table-lov',
	templateUrl: './html/partner-experience-table-lov.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: PartnerExperienceTableLOVComponent,
			multi: true
		}
	]
})
export class PartnerExperienceTableLOVComponent extends PartnerExperienceTableLOVBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
