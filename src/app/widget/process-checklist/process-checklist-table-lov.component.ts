...
import {ProcessChecklistTableLOVBaseComponent} from './base/process-checklist-table-lov.component.base';
import {TABLE_LOV_CONFIG} from './config/table-lov-config.js';

@Component({
	selector: 'app-process-checklist-table-lov',
	templateUrl: './html/process-checklist-table-lov.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: ProcessChecklistTableLOVComponent,
			multi: true
		}
	]
})
export class ProcessChecklistTableLOVComponent extends ProcessChecklistTableLOVBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
