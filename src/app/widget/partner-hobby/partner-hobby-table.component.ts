...
import {PartnerHobbyTableBaseComponent} from './base/partner-hobby-table.component.base';
import {TABLE_CONFIG} from './config/table-config.js';

@Component({
	selector: 'app-partner-hobby-table',
	templateUrl: './html/partner-hobby-table.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: PartnerHobbyTableComponent,
			multi: true
		}
	]
})
export class PartnerHobbyTableComponent extends PartnerHobbyTableBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
