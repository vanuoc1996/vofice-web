...
import {PartnerHobbyEditBaseComponent} from './base/partner-hobby-edit.component.base';
import {EDIT_CONFIG} from './config/edit-config.js';

@Component({
	selector: 'app-partner-hobby-edit',
	templateUrl: './html/partner-hobby-edit-uoc.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: PartnerHobbyEditComponent,
			multi: true
		}
	]
})
export class PartnerHobbyEditComponent extends PartnerHobbyEditBaseComponent implements OnInit {
	constructor(
		http: HttpClient,
		router: Router,
