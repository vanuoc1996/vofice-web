...
import {BankTypeEditBaseComponent} from './base/bank-type-edit.component.base';
import {EDIT_CONFIG} from './config/edit-config.js';

@Component({
	selector: 'app-bank-type-edit',
	templateUrl: './html/bank-type-edit.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: BankTypeEditComponent,
			multi: true
		}
	]
})
export class BankTypeEditComponent extends BankTypeEditBaseComponent implements OnInit {
	constructor(
		http: HttpClient,
		router: Router,
