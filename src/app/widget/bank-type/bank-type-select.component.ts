...
import {BankTypeSelectBaseComponent} from './base/bank-type-select.component.base';
import {SELECT_CONFIG} from './config/select-config.js';

@Component({
	selector: 'app-bank-type-select',
	templateUrl: './html/bank-type-select.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: BankTypeSelectComponent,
			multi: true
		}
	]
})
export class BankTypeSelectComponent extends BankTypeSelectBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
