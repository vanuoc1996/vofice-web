...
import {BankTypeTableBaseComponent} from './base/bank-type-table.component.base';
import {TABLE_CONFIG} from './config/table-config.js';

@Component({
	selector: 'app-bank-type-table',
	templateUrl: './html/bank-type-table.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: BankTypeTableComponent,
			multi: true
		}
	]
})
export class BankTypeTableComponent extends BankTypeTableBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
