...
import {ContactEmailSelectBaseComponent} from './base/contact-email-select.component.base';
import {SELECT_CONFIG} from './config/select-config.js';

@Component({
	selector: 'app-contact-email-select',
	templateUrl: './html/contact-email-select.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: ContactEmailSelectComponent,
			multi: true
		}
	]
})
export class ContactEmailSelectComponent extends ContactEmailSelectBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
