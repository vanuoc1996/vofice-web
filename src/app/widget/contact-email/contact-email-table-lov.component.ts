...
import {ContactEmailTableLOVBaseComponent} from './base/contact-email-table-lov.component.base';
import {TABLE_LOV_CONFIG} from './config/table-lov-config.js';

@Component({
	selector: 'app-contact-email-table-lov',
	templateUrl: './html/contact-email-table-lov.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: ContactEmailTableLOVComponent,
			multi: true
		}
	]
})
export class ContactEmailTableLOVComponent extends ContactEmailTableLOVBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
