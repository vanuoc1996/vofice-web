...
import {PartnerTypeEditBaseComponent} from './base/partner-type-edit.component.base';
import {EDIT_CONFIG} from './config/edit-config.js';

@Component({
	selector: 'app-partner-type-edit',
	templateUrl: './html/partner-type-edit.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: PartnerTypeEditComponent,
			multi: true
		}
	]
})
export class PartnerTypeEditComponent extends PartnerTypeEditBaseComponent implements OnInit {
	constructor(
		http: HttpClient,
		router: Router,
