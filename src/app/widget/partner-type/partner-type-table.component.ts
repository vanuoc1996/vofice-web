...
import {PartnerTypeTableBaseComponent} from './base/partner-type-table.component.base';
import {TABLE_CONFIG} from './config/table-config.js';

@Component({
	selector: 'app-partner-type-table',
	templateUrl: './html/partner-type-table.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: PartnerTypeTableComponent,
			multi: true
		}
	]
})
export class PartnerTypeTableComponent extends PartnerTypeTableBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
