...
import {RelationTypeEditBaseComponent} from './base/relation-type-edit.component.base';
import {EDIT_CONFIG} from './config/edit-config.js';

@Component({
	selector: 'app-relation-type-edit',
	templateUrl: './html/relation-type-edit.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: RelationTypeEditComponent,
			multi: true
		}
	]
})
export class RelationTypeEditComponent extends RelationTypeEditBaseComponent implements OnInit {
	constructor(
		http: HttpClient,
		router: Router,
