...
import {TerritorySelectBaseComponent} from './base/territory-entry-select.component.base';
import {SELECT_CONFIG} from './config/select-config.js';

@Component({
	selector: 'app-territory-select',
	templateUrl: './html/territory-entry-select.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: TerritorySelectComponent,
			multi: true
		}
	]
})
export class TerritorySelectComponent extends TerritorySelectBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
