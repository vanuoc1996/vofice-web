...
import {MeasureTableLOVBaseComponent} from './base/measure-entry-table-lov.component.base';
import {TABLE_LOV_CONFIG} from './config/table-lov-config.js';

@Component({
	selector: 'app-measure-table-lov',
	templateUrl: './html/measure-entry-table-lov.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: MeasureTableLOVComponent,
			multi: true
		}
	]
})
export class MeasureTableLOVComponent extends MeasureTableLOVBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
