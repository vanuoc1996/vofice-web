...
import {MeasureSelectBaseComponent} from './base/measure-entry-select.component.base';
import {SELECT_CONFIG} from './config/select-config.js';

@Component({
	selector: 'app-measure-select',
	templateUrl: './html/measure-entry-select.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: MeasureSelectComponent,
			multi: true
		}
	]
})
export class MeasureSelectComponent extends MeasureSelectBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
