...
import {DataTypeTableLOVBaseComponent} from './base/data-type-table-lov.component.base';
import {TABLE_LOV_CONFIG} from './config/table-lov-config.js';

@Component({
	selector: 'app-data-type-table-lov',
	templateUrl: './html/data-type-table-lov.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: DataTypeTableLOVComponent,
			multi: true
		}
	]
})
export class DataTypeTableLOVComponent extends DataTypeTableLOVBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
