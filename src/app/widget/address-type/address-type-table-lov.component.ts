...
import {AddressTypeTableLOVBaseComponent} from './base/address-type-table-lov.component.base';
import {TABLE_LOV_CONFIG} from './config/table-lov-config.js';

@Component({
	selector: 'app-address-type-table-lov',
	templateUrl: './html/address-type-table-lov.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: AddressTypeTableLOVComponent,
			multi: true
		}
	]
})
export class AddressTypeTableLOVComponent extends AddressTypeTableLOVBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
