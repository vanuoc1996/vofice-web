...
import {OrderTypeTableLOVBaseComponent} from './base/order-type-table-lov.component.base';
import {TABLE_LOV_CONFIG} from './config/table-lov-config.js';

@Component({
	selector: 'app-order-type-table-lov',
	templateUrl: './html/order-type-table-lov.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: OrderTypeTableLOVComponent,
			multi: true
		}
	]
})
export class OrderTypeTableLOVComponent extends OrderTypeTableLOVBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
