...
import {CompanyTypeTableLOVBaseComponent} from './base/company-type-table-lov.component.base';
import {TABLE_LOV_CONFIG} from './config/table-lov-config.js';

@Component({
	selector: 'app-company-type-table-lov',
	templateUrl: './html/company-type-table-lov.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: CompanyTypeTableLOVComponent,
			multi: true
		}
	]
})
export class CompanyTypeTableLOVComponent extends CompanyTypeTableLOVBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
