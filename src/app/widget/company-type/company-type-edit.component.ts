...
import {CompanyTypeEditBaseComponent} from './base/company-type-edit.component.base';
import {EDIT_CONFIG} from './config/edit-config.js';

@Component({
	selector: 'app-company-type-edit',
	templateUrl: './html/company-type-edit.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: CompanyTypeEditComponent,
			multi: true
		}
	]
})
export class CompanyTypeEditComponent extends CompanyTypeEditBaseComponent implements OnInit {
	constructor(
		http: HttpClient,
		router: Router,
