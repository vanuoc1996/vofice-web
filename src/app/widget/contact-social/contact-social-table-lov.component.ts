...
import {ContactSocialTableLOVBaseComponent} from './base/contact-social-table-lov.component.base';
import {TABLE_LOV_CONFIG} from './config/table-lov-config.js';

@Component({
	selector: 'app-contact-social-table-lov',
	templateUrl: './html/contact-social-table-lov.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: ContactSocialTableLOVComponent,
			multi: true
		}
	]
})
export class ContactSocialTableLOVComponent extends ContactSocialTableLOVBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
