...
import {ContactSocialEditBaseComponent} from './base/contact-social-edit.component.base';
import {EDIT_CONFIG} from './config/edit-config.js';

@Component({
	selector: 'app-contact-social-edit',
	templateUrl: './html/contact-social-edit.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: ContactSocialEditComponent,
			multi: true
		}
	]
})
export class ContactSocialEditComponent extends ContactSocialEditBaseComponent implements OnInit {
	constructor(
		http: HttpClient,
		router: Router,
