...
import {LicenseTypeEditBaseComponent} from './base/license-type-edit.component.base';
import {EDIT_CONFIG} from './config/edit-config.js';

@Component({
	selector: 'app-license-type-edit',
	templateUrl: './html/license-type-edit.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: LicenseTypeEditComponent,
			multi: true
		}
	]
})
export class LicenseTypeEditComponent extends LicenseTypeEditBaseComponent implements OnInit {
	constructor(
		http: HttpClient,
		router: Router,
