...
import {LicenseTypeTableBaseComponent} from './base/license-type-table.component.base';
import {TABLE_CONFIG} from './config/table-config.js';

@Component({
	selector: 'app-license-type-table',
	templateUrl: './html/license-type-table.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: LicenseTypeTableComponent,
			multi: true
		}
	]
})
export class LicenseTypeTableComponent extends LicenseTypeTableBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
