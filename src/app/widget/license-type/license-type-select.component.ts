...
import {LicenseTypeSelectBaseComponent} from './base/license-type-select.component.base';
import {SELECT_CONFIG} from './config/select-config.js';

@Component({
	selector: 'app-license-type-select',
	templateUrl: './html/license-type-select.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: LicenseTypeSelectComponent,
			multi: true
		}
	]
})
export class LicenseTypeSelectComponent extends LicenseTypeSelectBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
