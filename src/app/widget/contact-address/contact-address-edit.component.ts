...
import {ContactAddressEditBaseComponent} from './base/contact-address-edit.component.base';
import {EDIT_CONFIG} from './config/edit-config.js';

@Component({
	selector: 'app-contact-address-edit',
	templateUrl: './html/contact-address-edit.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: ContactAddressEditComponent,
			multi: true
		}
	]
})
export class ContactAddressEditComponent extends ContactAddressEditBaseComponent implements OnInit {
	constructor(
		http: HttpClient,
		router: Router,
