...
import {DomainTreeBaseComponent} from './base/domain-entry-tree.component.base';
import {TREE_CONFIG} from './config/tree-config.js';

@Component({
	selector: 'app-domain-tree',
	templateUrl: './html/domain-entry-tree.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: DomainTreeComponent,
			multi: true
		}
	]
})
export class DomainTreeComponent extends DomainTreeBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
