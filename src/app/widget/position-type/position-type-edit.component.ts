...
import {PositionTypeEditBaseComponent} from './base/position-type-edit.component.base';
import {EDIT_CONFIG} from './config/edit-config.js';

@Component({
	selector: 'app-position-type-edit',
	templateUrl: './html/position-type-edit.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: PositionTypeEditComponent,
			multi: true
		}
	]
})
export class PositionTypeEditComponent extends PositionTypeEditBaseComponent implements OnInit {
	constructor(
		http: HttpClient,
		router: Router,
