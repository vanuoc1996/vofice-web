...
import {IndustryTypeEditBaseComponent} from './base/industry-type-edit.component.base';
import {EDIT_CONFIG} from './config/edit-config.js';

@Component({
	selector: 'app-industry-type-edit',
	templateUrl: './html/industry-type-edit.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: IndustryTypeEditComponent,
			multi: true
		}
	]
})
export class IndustryTypeEditComponent extends IndustryTypeEditBaseComponent implements OnInit {
	constructor(
		http: HttpClient,
		router: Router,
