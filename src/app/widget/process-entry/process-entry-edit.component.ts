...
import {ProcessEditBaseComponent} from './base/process-entry-edit.component.base';
import {EDIT_CONFIG} from './config/edit-config.js';

@Component({
	selector: 'app-process-edit',
	templateUrl: './html/process-entry-edit.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: ProcessEditComponent,
			multi: true
		}
	]
})
export class ProcessEditComponent extends ProcessEditBaseComponent implements OnInit {
	constructor(
		http: HttpClient,
		router: Router,
