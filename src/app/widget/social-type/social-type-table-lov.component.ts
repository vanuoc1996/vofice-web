...
import {SocialTypeTableLOVBaseComponent} from './base/social-type-table-lov.component.base';
import {TABLE_LOV_CONFIG} from './config/table-lov-config.js';

@Component({
	selector: 'app-social-type-table-lov',
	templateUrl: './html/social-type-table-lov.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: SocialTypeTableLOVComponent,
			multi: true
		}
	]
})
export class SocialTypeTableLOVComponent extends SocialTypeTableLOVBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
