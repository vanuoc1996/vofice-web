...
import {SocialTypeEditBaseComponent} from './base/social-type-edit.component.base';
import {EDIT_CONFIG} from './config/edit-config.js';

@Component({
	selector: 'app-social-type-edit',
	templateUrl: './html/social-type-edit.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: SocialTypeEditComponent,
			multi: true
		}
	]
})
export class SocialTypeEditComponent extends SocialTypeEditBaseComponent implements OnInit {
	constructor(
		http: HttpClient,
		router: Router,
