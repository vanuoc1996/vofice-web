...
import {ReligionTypeTableLOVBaseComponent} from './base/religion-type-table-lov.component.base';
import {TABLE_LOV_CONFIG} from './config/table-lov-config.js';

@Component({
	selector: 'app-religion-type-table-lov',
	templateUrl: './html/religion-type-table-lov.html',
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: ReligionTypeTableLOVComponent,
			multi: true
		}
	]
})
export class ReligionTypeTableLOVComponent extends ReligionTypeTableLOVBaseComponent {
	constructor(
		http: HttpClient,
		router: Router,
